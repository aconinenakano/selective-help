    ...
    return {
        frames: {
            'welcome': {
                ...
                'blocks': [
                    {
                        'title': 'Welcome to "Find the expert puzzler!"'
                    },
                    {
                        'text': 'Thank you for your interest in our study, \'Find the Expert Puzzler!'
                    },
                    {
            ...
            'study-video': {
                ...
                'frameList': [{
                    ...
                    'parameterSets': [
                    { 'STUDY_VIDEO': 'CB1_Study1B' },
                    { 'STUDY_VIDEO': 'CB2_Study1B' },
                    { 'STUDY_VIDEO': 'CB3_Study1B' },
                    { 'STUDY_VIDEO': 'CB4_Study1B' },
                    { 'STUDY_VIDEO': 'CB5_Study1B' },
                    { 'STUDY_VIDEO': 'CB6_Study1B' },
                    { 'STUDY_VIDEO': 'CB7_Study1B' },
                    { 'STUDY_VIDEO': 'CB8_Study1B' }
                ]
            },
